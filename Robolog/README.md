...
## Goals
* Provide a convenient way to generate, store and retrieve telemetry logs generated by FRC robots running LabVIEW
* Expose telemetry data in a ready-to-consume format (JSON)
* Make the data accessible via HTTP to enable analysis in statistical environments such as R, interactive data visualization tools such as Tableau and Shiny and programs written in Python, Java, C++ and Node.js
...
## Components
* A custom LabVIEW VI module that acts as a central "data logger", recording robot metrics at 100ms intervals
* The CKAN Open Data portal for data ingestion, tagging, indexing, search, retrieval and collaboration 
