# Source: https://github.com/OpenCouncilData/Ckan-Upload/blob/master/ckan-upload.py
...
parser = MyParser(description='Uploads a file to update an existing resource a CKAN portal.') #,
