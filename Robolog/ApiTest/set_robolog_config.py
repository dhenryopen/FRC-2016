# set_robolog_config.py -- set robolog configuration via CLI and GUI
...
parser = argparse.ArgumentParser(prog='set_robolog_config',description='A program to set the robolog configuration parameters. "--match" should be updated for each match',
...
parser.add_argument('--ckan_url', action='store', dest='ckan_url', default='UNDEFINED',
                    help='Set the CKAN dataset url')
...
config.set('robolog:ckan', 'ckan_url', parameters.ckan_url)
...
print "Settings writtent to " + parameters.cfg_file
